...
// node_modules/@company/commons/dist/chunk-4OT2OVI3.js
...
import "/Users/bob/work/JINAIR/hjcho1/test-site-a/node_modules/@company/commons/node_modules/react-toastify/dist/ReactToastify.css";
...
var useToast = () => {
  ...
  const success = (0, import_react2.useCallback)(createPublisher("success"), []);
  const error = (0, import_react2.useCallback)(createPublisher("error"), []);
  const warning = (0, import_react2.useCallback)(createPublisher("warning"), []);
  const info = (0, import_react2.useCallback)(createPublisher("info"), []);
  const defaultToast = (0, import_react2.useCallback)(createPublisher("default"), []);
  return {
    publish,
    success,
    error,
