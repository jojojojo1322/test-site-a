...
// node_modules/@company/commons/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/@company/commons/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    "use strict";
    (function() {
      function is(x2, y2) {
...
// node_modules/@company/commons/node_modules/use-sync-external-store/shim/index.js
var require_shim = __commonJS({
  "node_modules/@company/commons/node_modules/use-sync-external-store/shim/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/@company/commons/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js
var require_with_selector_development = __commonJS({
  "node_modules/@company/commons/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    "use strict";
    (function() {
      function is(x2, y2) {
        return x2 === y2 && (0 !== x2 || 1 / x2 === 1 / y2) || x2 !== x2 && y2 !== y2;
...
// node_modules/@company/commons/node_modules/use-sync-external-store/shim/with-selector.js
var require_with_selector = __commonJS({
  "node_modules/@company/commons/node_modules/use-sync-external-store/shim/with-selector.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/@company/commons/dist/chunk-W4VA3BIV.js
var import_react3 = __toESM(require_react(), 1);

// node_modules/@company/commons/node_modules/react-toastify/dist/react-toastify.esm.mjs
...
// node_modules/@company/commons/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/@company/commons/node_modules/zustand/esm/index.mjs
...
import "/Users/bob/work/JINAIR/hjcho1/demo-app/node_modules/@company/commons/node_modules/react-toastify/dist/ReactToastify.css";
...
${message}` : message;
  switch (variant) {
    case "success":
      B.success(decoratedMessage, { toastId: id, ...options });
      break;
    case "error":
      B.error(decoratedMessage, { toastId: id, ...options });
      break;
    case "warning":
      B.warning(decoratedMessage, { toastId: id, ...options });
      break;
    case "info":
      B.info(decoratedMessage, { toastId: id, ...options });
      break;
    default:
      B(decoratedMessage, { toastId: id, ...options });
      break;
  }
};
...
var ToastProvider = ({ children, containerProps }) => {
  (0, import_react3.useEffect)(() => {
    const unsubscribe = useToastStore.subscribe(
      (state, prevState) => {
        if (state.queue === (prevState == null ? void 0 : prevState.queue)) {
          return;
        }
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    children,
    (0, import_jsx_runtime.jsx)(Q, { ...DEFAULT_CONTAINER_PROPS, ...containerProps })
  ] });
};
...
var useToast = () => {
  ...
  const success = (0, import_react3.useCallback)(createPublisher("success"), []);
  const error = (0, import_react3.useCallback)(createPublisher("error"), []);
  const warning = (0, import_react3.useCallback)(createPublisher("warning"), []);
  const info = (0, import_react3.useCallback)(createPublisher("info"), []);
  const defaultToast = (0, import_react3.useCallback)(createPublisher("default"), []);
  return {
    publish,
    success,
    error,
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=@company_commons_store.js.map
